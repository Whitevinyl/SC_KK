...
function FilterSetup() {
    ...
    for (var i=0; i< FilterStyles.length; i++) {
        ...
        span.ontouchstart = function(e) {StyleSelected(e.targetTouches[0]);};
    }
    ...
    reset.ontouchstart = function() {FilterReset();};
}
...
function SliderSetup(element, min, max, value1, value2, setting, labelArray) {
    ...
    sliderObj.handle1.element.ontouchstart = function(e) {HandleStart(e.targetTouches[0],sliderObj.handle1);};
    sliderObj.handle2.element.ontouchstart = function(e) {HandleStart(e.targetTouches[0],sliderObj.handle2);};
